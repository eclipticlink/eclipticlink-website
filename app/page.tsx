...
export default function Home() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-zinc-900 px-4 py-24 text-white sm:px-6 sm:py-32 lg:px-8" aria-labelledby="hero-heading">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/contact"
              className="inline-flex h-12 min-h-11 items-center justify-center rounded-lg bg-white px-6 text-base font-semibold text-zinc-900 shadow-sm transition hover:bg-zinc-100 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white"
            >
              Get Started
            </Link>
            <Link
              href="/services"
              className="inline-flex h-12 min-h-11 items-center justify-center rounded-lg border border-zinc-500 bg-transparent px-6 text-base font-semibold text-white transition hover:bg-zinc-800 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white"
            >
              Our Services
            </Link>
          </div>
      ...
      <section id="services" className="bg-white px-4 py-20 sm:px-6 sm:py-28 lg:px-8" aria-labelledby="services-heading">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            <h2 id="services-heading" className="text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">
              Services
            </h2>
          ...
          <div className="mx-auto mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service) => (
              <article
                key={service.id}
                className="rounded-xl border border-zinc-200 bg-zinc-50/50 p-6 shadow-sm transition hover:shadow-md"
              >
          ...
          <div className="mt-12 text-center">
            <Link
              href="/services"
              className="inline-flex h-11 items-center justify-center rounded-lg bg-zinc-900 px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-zinc-800 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-zinc-900"
            >
              View all services
            </Link>
          </div>
      ...
      <section className="bg-zinc-50 px-4 py-20 sm:px-6 sm:py-28 lg:px-8" aria-labelledby="about-heading">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              <h2 id="about-heading" className="text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">
                About EclipticLink
              </h2>
              <p className="mt-4 text-lg leading-8 text-zinc-600">
            ...
            <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm lg:p-8">
              <h3 className="text-lg font-semibold text-zinc-900">Why work with us</h3>
              <ul className="mt-4 space-y-3" role="list">
                <li className="flex gap-3">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-zinc-900 text-white" aria-hidden>✓</span>
      ...
      <section className="bg-white px-4 py-20 sm:px-6 sm:py-28 lg:px-8" aria-labelledby="why-heading">
        <div className="mx-auto max-w-7xl">
          ...
          <ul className="mx-auto mt-16 grid max-w-4xl gap-6 sm:grid-cols-2" role="list">
            <li className="rounded-xl border border-zinc-200 bg-zinc-50/50 p-6">
              Consultancy approach, dedicated experienced project manager to resolve any type of issues.
            </li>
            <li className="rounded-xl border border-zinc-200 bg-zinc-50/50 p-6">
          ...
          <p className="mx-auto mt-12 max-w-3xl text-center text-zinc-600">
      ...
      <section className="bg-zinc-900 px-4 py-20 text-white sm:px-6 sm:py-28 lg:px-8" aria-labelledby="hire-heading">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link
              href="/hire"
              className="inline-flex h-12 min-h-11 items-center justify-center rounded-lg bg-white px-6 text-base font-semibold text-zinc-900 shadow-sm transition hover:bg-zinc-100 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white focus-visible:ring-offset-zinc-900"
            >
              Hire your team
            </Link>
            <Link
              href="/contact"
              className="inline-flex h-12 min-h-11 items-center justify-center rounded-lg border border-zinc-500 px-6 text-base font-semibold text-white transition hover:bg-zinc-800 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white focus-visible:ring-offset-zinc-900"
            >
              Get a consultation
            </Link>
          </div>
      ...
      <section className="bg-zinc-50 px-4 py-20 sm:px-6 sm:py-28 lg:px-8" aria-labelledby="work-heading">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            <h2 id="work-heading" className="text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">
              What we deliver
            </h2>
          ...
          <div className="mx-auto mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-zinc-900">AI & data solutions</h3>
              <p className="mt-2 text-zinc-600">AI integrations, chatbots, data pipelines, analytics, and ML-ready infrastructure.</p>
            </div>
            <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-zinc-900">Custom software & SaaS</h3>
            ...
            <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-zinc-900">Mobile & web apps</h3>
      ...
      <section className="bg-white px-4 py-20 sm:px-6 sm:py-28 lg:px-8" aria-labelledby="testimonials-heading">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            <h2 id="testimonials-heading" className="text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">
              Testimonials
            </h2>
            <p className="mt-4 text-lg text-zinc-600">
          ...
          <div className="mx-auto mt-16 grid gap-8 md:grid-cols-3">
            <blockquote className="rounded-xl border border-zinc-200 bg-zinc-50/50 p-6">
              ...
              <footer className="mt-4">
                <cite className="not-italic">
                  <span className="font-semibold text-zinc-900">Steve V.</span>
            ...
            <blockquote className="rounded-xl border border-zinc-200 bg-zinc-50/50 p-6">
              ...
              <footer className="mt-4">
                <cite className="not-italic">
                  <span className="font-semibold text-zinc-900">Artwell K.</span>
                  <span className="block text-sm text-zinc-600">CEO & Founder</span>
                </cite>
              </footer>
            </blockquote>
            <blockquote className="rounded-xl border border-zinc-200 bg-zinc-50/50 p-6">
              ...
              <footer className="mt-4">
                <cite className="not-italic">
                  <span className="font-semibold text-zinc-900">Huzaifa Sarmad</span>
                  <span className="block text-sm text-zinc-600">CEO & Founder</span>
                </cite>
              </footer>
            </blockquote>
      ...
      <section className="bg-zinc-50 px-4 py-20 sm:px-6 sm:py-28 lg:px-8" aria-labelledby="faq-heading">
        <div className="mx-auto max-w-3xl">
          <h2 id="faq-heading" className="text-center text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">
      ...
      {/* CTA - Get in touch */}
      <section className="bg-zinc-900 px-4 py-20 text-white sm:px-6 sm:py-28 lg:px-8" aria-labelledby="cta-heading">
